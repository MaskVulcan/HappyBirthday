/* 代码整理：大安溪网 www.daanxi.com */
(function(a2, aF) {
	var w, ai, l = a2.document, aL = a2.location, bi = a2.jQuery, H = a2.$, aa = {}, a6 = [], s = "1.9.0", aH = a6.concat, ao = a6.push, a4 = a6.slice, aM = a6.indexOf, z = aa.toString, V = aa.hasOwnProperty, aQ = s.trim, bI = function(
			e, b1) {
		return new bI.fn.init(e, b1, w)
	}, bz = /[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source, ac = /\S+/g, C = /^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g, bp = /^(?:(<[\w\W]+>)[^>]*|#([\w-]*))$/, a = /^<(\w+)\s*\/?>(?:<\/\1>|)$/, bh = /^[\],:{}\s]*$/, bk = /(?:^|:|,)(?:\s*\[)+/g, bF = /\\(?:["\\\/bfnrt]|u[\da-fA-F]{4})/g, aZ = /"[^"\\\r\n]*"|true|false|null|-?(?:\d+\.|)\d+(?:[eE][+-]?\d+|)/g, bR = /^-ms-/, aV = /-([\da-z])/gi, M = function(
			e, b1) {
			...
			if (typeof e === "string") {
				...
				if (b1 && (b1[1] || !b3)) {
					if (b1[1]) {
						...
						bI.merge(this, bI.parseHTML(b1[1],
								b3 && b3.nodeType ? b3.ownerDocument || b3 : l,
								true));
		...
		for (; b4 < b3; b4++) {
			if ((b9 = arguments[b4]) != null) {
				for (b2 in b9) {
					...
					if (b8 && b1
							&& (bI.isPlainObject(b1) || (b6 = bI.isArray(b1)))) {
						if (b6) {
							b6 = false;
							b7 = e && bI.isArray(e) ? e : []
						} else {
	...
	bI.extend({
		...
		type : function(e) {
			...
			return typeof e === "object" || typeof e === "function" ? aa[z
					.call(e)]
					|| "object" : typeof e
		},
		isPlainObject : function(b3) {
			if (!b3 || bI.type(b3) !== "object" || b3.nodeType
					|| bI.isWindow(b3)) {
				return false
			}
			try {
				if (b3.constructor && !V.call(b3, "constructor")
						&& !V.call(b3.constructor.prototype, "isPrototypeOf")) {
					return false
				}
			} catch (b2) {
				return false
		...
		parseXML : function(b3) {
			...
			if (!b1 || !b1.documentElement
					|| b1.getElementsByTagName("parsererror").length) {
		...
		access : function(e, b5, b7, b6, b3, b9, b8) {
			...
			if (bI.type(b7) === "object") {
				...
				if (b6 !== aF) {
					...
					if (b5) {
						for (; b2 < b1; b2++) {
							b5(e[b2], b7, b8 ? b6 : b6.call(e[b2], b2, b5(
									e[b2], b7)))
						}
					}
				}
	...
	bI.each("Boolean Number String Function Array Date RegExp Object Error"
			.split(" "), function(b1, e) {
	...
	bI.Callbacks = function(ca) {
		...
		var b3, e, b4, b2, b5, b6, b7 = [], b8 = !ca.once && [], b1 = function(
				cb) {
			b3 = ca.memory && cb;
			e = true;
			b6 = b2 || 0;
	...
	bI
			.extend({
				Deferred : function(b2) {
					var b1 = [
							[ "resolve", "done", bI.Callbacks("once memory"),
									"resolved" ],
							[ "reject", "fail", bI.Callbacks("once memory"),
									"rejected" ],
							[ "notify", "progress", bI.Callbacks("memory") ] ], b3 = "pending", b4 = {
						state : function() {
							return b3
						},
						always : function() {
				...
				when : function(b4) {
					var b2 = 0, b6 = a4.call(arguments), e = b6.length, b1 = e !== 1
							|| (b4 && bI.isFunction(b4.promise)) ? e : 0, b9 = b1 === 1 ? b4
							: bI.Deferred(), b3 = function(cb, cc, ca) {
						return function(cd) {
							cc[cb] = this;
							ca[cb] = arguments.length > 1 ? a4.call(arguments)
									: cd;
							if (ca === b8) {
								b9.notifyWith(cc, ca)
							} else {
	...
	bI.support = (function() {
		...
		for (b4 in {
			...
			cc[b4 + "Bubbles"] = b5 in a2
					|| b1.attributes[b5].expando === false
		}
		...
		bI(function() {
			var cd, cg, cf, ce = "padding:0;margin:0;border:0;display:block;box-sizing:content-box;-moz-box-sizing:content-box;-webkit-box-sizing:content-box;", e = l
			...
			if (a2.getComputedStyle) {
				...
				cc.boxSizingReliable = (a2.getComputedStyle(b1, null) || {
					width : "4px"
				}).width === "4px";
				...
				b1.style.width = "1px";
				cc.reliableMarginRight = !parseFloat((a2.getComputedStyle(cg,
						null) || {}).marginRight)
			}
	...
	function ba(b3, b1, b5, b4) {
		...
		var b6, b8, b9 = bI.expando, b7 = typeof b1 === "string", ca = b3.nodeType, e = ca ? bI.cache
	...
	function Z(b3, b1, b4) {
		...
		var b7, b6, b5, b8 = b3.nodeType, e = b8 ? bI.cache : b3, b2 = b8 ? b3[bI.expando]
				: bI.expando;
		if (!e[b2]) {
			return
		}
	...
	function bx(b3, b2, b4) {
		if (b4 === aF && b3.nodeType === 1) {
			...
			if (typeof b4 === "string") {
				try {
					b4 = b4 === "true" ? true : b4 === "false" ? false
							: b4 === "null" ? null : +b4 + "" === b4 ? +b4 : bv
									.test(b4) ? bI.parseJSON(b4) : b4
				} catch (b5) {
				}
				bI.data(b3, b2, b4)
			} else {
	...
	bI.extend({
		...
		dequeue : function(b5, b4) {
			b4 = b4 || "fx";
			var b1 = bI.queue(b5, b4), b6 = b1.length, b3 = b1.shift(), e = bI
					._queueHooks(b5, b4), b2 = function() {
				bI.dequeue(b5, b4)
			};
			if (b3 === "inprogress") {
				b3 = b1.shift();
	...
	bI.fn
			.extend({
				attr : function(e, b1) {
					return bI
							.access(this, bI.attr, e, b1, arguments.length > 1)
				},
				...
				prop : function(e, b1) {
					return bI
							.access(this, bI.prop, e, b1, arguments.length > 1)
				},
				...
				addClass : function(b7) {
					var b1, e, b8, b4, b2, b3 = 0, b5 = this.length, b6 = typeof b7 === "string"
							&& b7;
					if (bI.isFunction(b7)) {
						return this
								.each(function(b9) {
									bI(this).addClass(
											b7.call(this, b9, this.className))
								})
					}
					if (b6) {
						b1 = (b7 || "").match(ac) || [];
				...
				removeClass : function(b7) {
					var b1, e, b8, b4, b2, b3 = 0, b5 = this.length, b6 = arguments.length === 0
							|| typeof b7 === "string" && b7;
					if (bI.isFunction(b7)) {
				...
				toggleClass : function(b3, b1) {
					...
					return this
							.each(function() {
								if (b2 === "string") {
									var b6, b5 = 0, b4 = bI(this), b7 = b1, b8 = b3
											.match(ac)
											|| [];
									while ((b6 = b8[b5++])) {
				...
				val : function(b3) {
					...
					if (!arguments.length) {
						if (b2) {
							e = bI.valHooks[b2.type]
									|| bI.valHooks[b2.nodeName.toLowerCase()];
							if (e && "get" in e
									&& (b1 = e.get(b2, "value")) !== aF) {
								return b1
							}
							b1 = b2.value;
							return typeof b1 === "string" ? b1.replace(ak, "")
									: b1 == null ? "" : b1
						}
						return
					}
					...
					return this.each(function(b6) {
						...
						e = bI.valHooks[this.type]
								|| bI.valHooks[this.nodeName.toLowerCase()];
						if (!e || !("set" in e)
								|| e.set(this, b7, "value") === aF) {
							this.value = b7
						}
					})
				}
	...
	bI
			.extend({
				valHooks : {
					...
					select : {
						get : function(e) {
							var b6, b2, b8 = e.options, b4 = e.selectedIndex, b3 = e.type === "select-one"
									|| b4 < 0, b7 = b3 ? null : [], b5 = b3 ? b4 + 1
									: b8.length, b1 = b4 < 0 ? b5 : b3 ? b4 : 0;
							for (; b1 < b5; b1++) {
								b2 = b8[b1];
								if ((b2.selected || b1 === b4)
										&& (bI.support.optDisabled ? !b2.disabled
												: b2.getAttribute("disabled") === null)
										&& (!b2.parentNode.disabled || !bI
												.nodeName(b2.parentNode,
														"optgroup"))) {
									b6 = bI(b2).val();
									if (b3) {
										return b6
						...
						set : function(b1, b2) {
							...
							bI(b1).find("option").each(
									function() {
										this.selected = bI.inArray(bI(this)
												.val(), e) >= 0
									});
							if (!e.length) {
								b1.selectedIndex = -1
				...
				attrHooks : {
					type : {
						set : function(e, b1) {
							if (!bI.support.radioValue && b1 === "radio"
									&& bI.nodeName(e, "input")) {
								var b2 = e.value;
				...
				propHooks : {
					tabIndex : {
						get : function(b1) {
							...
							return e && e.specified ? parseInt(e.value, 10)
									: aE.test(b1.nodeName)
											|| D.test(b1.nodeName) && b1.href ? 0
											: aF
						}
					}
				}
	...
	bX = {
		get : function(b3, b1) {
			var b4 = bI.prop(b3, b1), e = typeof b4 === "boolean"
					&& b3.getAttribute(b1), b2 = typeof b4 === "boolean" ? bE
					&& bO ? e != null : aq.test(b1) ? b3[bI
					.camelCase("default-" + b1)] : !!e : b3
					.getAttributeNode(b1);
	...
	if (!bE || !bO) {
		bI.attrHooks.value = {
			get : function(b2, b1) {
				...
				return bI.nodeName(b2, "input") ? b2.defaultValue : e
						&& e.specified ? e.value : aF
			},
			set : function(b1, b2, e) {
	...
	if (!bO) {
		a8 = bI.valHooks.button = {
			get : function(b2, b1) {
				var e = b2.getAttributeNode(b1);
				return e
						&& (b1 === "id" || b1 === "name" || b1 === "coords" ? e.value !== ""
								: e.specified) ? e.value : aF
			},
			set : function(b2, b3, b1) {
				var e = b2.getAttributeNode(b1);
				if (!e) {
					b2.setAttributeNode((e = b2.ownerDocument
							.createAttribute(b1)))
				}
				e.value = b3 += "";
	...
	bI.event = {
		...
		add : function(b4, b9, cg, b6, b5) {
			var b2, b8, b7, cf, ce, cd, cb, b3, cc, e, b1, ca = b4.nodeType !== 3
					&& b4.nodeType !== 8 && bI._data(b4);
			if (!ca) {
				return
			}
			if (cg.handler) {
			...
			if (!(b8 = ca.handle)) {
				b8 = ca.handle = function(ch) {
					return typeof bI !== "undefined"
							&& (!ch || bI.event.triggered !== ch.type) ? bI.event.dispatch
							.apply(b8.elem, arguments)
							: aF
				};
				b8.elem = b4
			}
		...
		remove : function(b3, b9, cg, b4, b8) {
			var b6, b5, b7, cf, ce, cd, cb, b2, cc, e, b1, ca = bI.hasData(b3)
					&& bI._data(b3);
			if (!ca || !(cf = ca.events)) {
				return
			}
			...
			while (ce--) {
				...
				while (b6--) {
					cd = b2[b6];
					if ((b8 || b1 === cd.origType)
							&& (!cg || cg.guid === cd.guid)
							&& (!b7 || b7.test(cd.namespace))
							&& (!b4 || b4 === cd.selector || b4 === "**"
									&& cd.selector)) {
						b2.splice(b6, 1);
						if (cd.selector) {
							b2.delegateCount--
				...
				if (b5 && !b2.length) {
					if (!cb.teardown
							|| cb.teardown.call(b3, e, ca.handle) === false) {
		...
		trigger : function(b1, b6, b4, cf) {
			var b7, cd, b8, ce, b3, b9, cb, b5 = [ b4 || l ], cc = b1.type
					|| b1, b2 = b1.namespace ? b1.namespace.split(".") : [];
			cd = b8 = b4 = b4 || l;
			...
			b1 = b1[bI.expando] ? b1 : new bI.Event(cc, typeof b1 === "object"
					&& b1);
			b1.isTrigger = true;
			...
			while ((cd = b5[b7++]) && !b1.isPropagationStopped()) {
				...
				b9 = (bI._data(cd, "events") || {})[b1.type]
						&& bI._data(cd, "handle");
				if (b9) {
					b9.apply(cd, b6)
				}
				b9 = b3 && cd[b3];
				if (b9 && bI.acceptData(cd) && b9.apply
						&& b9.apply(cd, b6) === false) {
					b1.preventDefault()
				}
			}
			b1.type = cc;
			if (!cf && !b1.isDefaultPrevented()) {
				if ((!cb._default || cb._default.apply(b4.ownerDocument, b6) === false)
						&& !(cc === "click" && bI.nodeName(b4, "a"))
						&& bI.acceptData(b4)) {
		...
		dispatch : function(e) {
			e = bI.event.fix(e);
			var b4, b3, b5, b1, b9, b8 = [], b7 = a4.call(arguments), b2 = (bI
			...
			while ((b1 = b8[b4++]) && !e.isPropagationStopped()) {
				...
				b3 = 0;
				while ((b9 = b1.handlers[b3++])
						&& !e.isImmediatePropagationStopped()) {
					if (!e.namespace_re || e.namespace_re.test(b9.namespace)) {
						e.handleObj = b9;
						e.data = b9.data;
						b5 = ((bI.event.special[b9.origType] || {}).handle || b9.handler)
								.apply(b1.elem, b7);
						if (b5 !== aF) {
				...
				for (; b8 != this; b8 = b8.parentNode || this) {
					if (b8.disabled !== true || e.type !== "click") {
						...
						for (b4 = 0; b4 < b3; b4++) {
							...
							b1 = b7.selector + " ";
							if (b5[b1] === aF) {
								b5[b1] = b7.needsContext ? bI(b1, this).index(
										b8) >= 0 : bI.find(b1, this, null,
										[ b8 ]).length
							}
							if (b5[b1]) {
								b5.push(b7)
		...
		fix : function(b2) {
			...
			var b1, b5, e = b2, b3 = bI.event.fixHooks[b2.type] || {}, b4 = b3.props ? this.props
					.concat(b3.props)
					: this.props;
			b2 = new bI.Event(e);
			b1 = b4.length;
		...
		mouseHooks : {
			...
			filter : function(b3, b2) {
				...
				if (b3.pageX == null && b2.clientX != null) {
					...
					e = b4.body;
					b3.pageX = b2.clientX
							+ (b5 && b5.scrollLeft || e && e.scrollLeft || 0)
							- (b5 && b5.clientLeft || e && e.clientLeft || 0);
					b3.pageY = b2.clientY
							+ (b5 && b5.scrollTop || e && e.scrollTop || 0)
							- (b5 && b5.clientTop || e && e.clientTop || 0)
				}
		...
		special : {
			...
			click : {
				trigger : function() {
					if (bI.nodeName(this, "input") && this.type === "checkbox"
							&& this.click) {
						this.click();
						return false
					}
	...
	if (!bI.support.submitBubbles) {
		bI.event.special.submit = {
			setup : function() {
				...
				bI.event.add(this, "click._submit keypress._submit", function(
						b3) {
					var b2 = b3.target, b1 = bI.nodeName(b2, "input")
							|| bI.nodeName(b2, "button") ? b2.form : aF;
	...
	if (!bI.support.changeBubbles) {
		bI.event.special.change = {
			setup : function() {
				...
				bI.event.add(this, "beforeactivate._change",
						function(b2) {
							var b1 = b2.target;
							if (bG.test(b1.nodeName)
									&& !bI._data(b1, "changeBubbles")) {
								bI.event.add(b1, "change._change", function(e) {
									if (this.parentNode && !e.isSimulated
											&& !e.isTrigger) {
										bI.event.simulate("change",
			...
			handle : function(b1) {
				var e = b1.target;
				if (this !== e || b1.isSimulated || b1.isTrigger
	...
	bI.fn.extend({
		...
		undelegate : function(e, b1, b2) {
			return arguments.length === 1 ? this.off(e, "**") : this.off(b1, e
					|| "**", b2)
		},
			...
			.each(
					("blur focus focusin focusout load resize scroll unload click dblclick mousedown mouseup mousemove mouseover mouseout mouseenter mouseleave change select submit keydown keypress keyup error contextmenu")
						...
						bI.fn[e] = function(b3, b2) {
							return arguments.length > 0 ? this.on(e, null, b3,
									b2) : this.trigger(e)
						};
						if (a3.test(e)) {
	...
	(function(c8, cf) {
		var cv, b9, cl, cF, cH, cQ, cR, de, cT, cz, cm, cb, cX, c9, b8, cD, cB, c3 = "sizzle"
				+ -(new Date()), cG = c8.document, db = {}, dc = 0, cY = 0, b3 = cx(), c2 = cx(), cE = cx(), c7 = typeof cf, cL = 1 << 31, c5 = [], c6 = c5.pop, b2 = c5.push, ck = c5.slice, b7 = c5.indexOf
				|| function(dg) {
					...
					return -1
				}, cn = "[\\x20\\t\\r\\n\\f]", b1 = "(?:\\\\.|[\\w-]|[^\\x00-\\xa0])+", cI = b1
				.replace("w", "w#"), cg = "([*^$|!~]?=)", c0 = "\\[" + cn
				+ "*(" + b1 + ")" + cn + "*(?:" + cg + cn
				+ "*(?:(['\"])((?:\\\\.|[^\\\\])*?)\\3|(" + cI + ")|)|)" + cn
				+ "*\\]", ci = ":("
				+ b1
				+ ")(?:\\(((['\"])((?:\\\\.|[^\\\\])*?)\\3|((?:\\\\.|[^\\\\()[\\]]|"
				+ c0.replace(3, 8) + ")*)|.*)\\)|)", cp = new RegExp("^" + cn
				+ "+|((?:^|[^\\\\])(?:\\\\.)*)" + cn + "+$", "g"), cs = new RegExp(
				"^" + cn + "*," + cn + "*"), cy = new RegExp("^" + cn
				+ "*([\\x20\\t\\r\\n\\f>+~])" + cn + "*"), cN = new RegExp(ci), cO = new RegExp(
				"^" + cI + "$"), cW = {
			ID : new RegExp("^#(" + b1 + ")"),
			CLASS : new RegExp("^\\.(" + b1 + ")"),
			...
			CHILD : new RegExp(
					"^:(only|first|last|nth|nth-last)-(child|of-type)(?:\\("
							...
							+ "*(?:([+-]|)" + cn + "*(\\d+)|))" + cn + "*\\)|)",
					"i"),
			needsContext : new RegExp("^" + cn
					+ "*[>+~]|:(even|odd|eq|gt|lt|nth|first|last)(?:\\(" + cn
					+ "*((?:-\\d)?\\d*)" + cn + "*\\)|)(?=[^-]|$)", "i")
		}, cU = /[\x20\t\r\n\f]*[+~]/, cK = /\{\s*\[native code\]\s*\}/, cM = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/, b6 = /^(?:input|select|textarea|button)$/i, cj = /^h\d$/i, cJ = /'|\\/g, cr = /\=[\x20\t\r\n\f]*([^'"\]]*)[\x20\t\r\n\f]*\]/g, cq = /\\([\da-fA-F]{1,6}[\x20\t\r\n\f]?|.)/g, cZ = function(
				e, dg) {
			var df = "0x" + dg - 65536;
			return df !== df ? dg : df < 0 ? String.fromCharCode(df + 65536)
					: String.fromCharCode(df >> 10 | 55296, df & 1023 | 56320)
		};
		try {
			...
			if (!cb && !dt) {
				if ((ds = cM.exec(dm))) {
					if ((dk = ds[1])) {
						...
						if (ds[2]) {
							b2.apply(dr, ck
									.call(df.getElementsByTagName(dm), 0));
							return dr
						} else {
							if ((dk = ds[3]) && db.getByClassName
									&& df.getElementsByClassName) {
								b2.apply(dr, ck.call(df
										.getElementsByClassName(dk), 0));
								return dr
							}
						}
					}
		...
		cT = ct.setDocument = function(e) {
			...
			db.getByClassName = ca(function(dg) {
				...
				if (!dg.getElementsByClassName
						|| !dg.getElementsByClassName("e").length) {
					return false
				}
			...
			db.getByName = ca(function(dh) {
				dh.id = c3 + 0;
				dh.innerHTML = "<a name='" + c3 + "'></a><div name='" + c3
						+ "'></div>";
				cm.insertBefore(dh, cm.firstChild);
				var dg = df.getElementsByName
						&& df.getElementsByName(c3).length === 2 + df
								.getElementsByName(c3 + 0).length;
			...
			cl.attrHandle = ca(function(dg) {
				...
				return dg.firstChild
						&& typeof dg.firstChild.getAttribute !== c7
						&& dg.firstChild.getAttribute("href") === "#"
			}) ? {} : {
				href : function(dg) {
			...
			if (db.getIdNotName) {
				...
				cl.find.ID = function(di, dh) {
					if (typeof dh.getElementById !== c7 && !cb) {
						var dg = dh.getElementById(di);
						return dg ? dg.id === di
								|| typeof dg.getAttributeNode !== c7
								&& dg.getAttributeNode("id").value === di ? [ dg ]
								: cf
								: []
					}
				};
				cl.filter.ID = function(dh) {
					var dg = dh.replace(cq, cZ);
					return function(dj) {
						var di = typeof dj.getAttributeNode !== c7
								&& dj.getAttributeNode("id");
			...
			if ((db.matchesSelector = cC((b8 = cm.matchesSelector
					|| cm.mozMatchesSelector || cm.webkitMatchesSelector
			...
			cD = cC(cm.contains) || cm.compareDocumentPosition ? function(dh,
					dg) {
				var dj = dh.nodeType === 9 ? dh.documentElement : dh, di = dg
						&& dg.parentNode;
				return dh === di
						|| !!(di && di.nodeType === 1 && (dj.contains ? dj
								.contains(di) : dh.compareDocumentPosition
								&& dh.compareDocumentPosition(di) & 16))
			} : function(dh, dg) {
				if (dg) {
			...
			cB = cm.compareDocumentPosition ? function(dh, dg) {
				...
				if ((di = dg.compareDocumentPosition
						&& dh.compareDocumentPosition
						&& dh.compareDocumentPosition(dg))) {
					if (di & 1 || dh.parentNode
							&& dh.parentNode.nodeType === 11) {
						if (dh === df || cD(cG, dh)) {
							return -1
						}
						if (dg === df || cD(cG, dg)) {
					...
					: function(dh, dg) {
						...
						if (dh === dg) {
							...
							if (dh.sourceIndex && dg.sourceIndex) {
								return (~dg.sourceIndex || cL)
										- (cD(cG, dh) && ~dh.sourceIndex || cL)
							} else {
								if (!dm || !dj) {
									return dh === df ? -1 : dg === df ? 1
											: dm ? -1 : dj ? 1 : 0
								} else {
									if (dm === dj) {
										return b4(dh, dg)
						...
						return dk ? b4(di[dk], dl[dk]) : di[dk] === cG ? -1
								: dl[dk] === cG ? 1 : 0
					};
			cR = false;
			[ 0, 0 ].sort(cB);
		...
		ct.matchesSelector = function(dg, di) {
			...
			di = di.replace(cr, "='$1']");
			if (db.matchesSelector && !cb && (!c9 || !c9.test(di))
					&& !cX.test(di)) {
				try {
					var df = b8.call(dg, di);
					if (df || db.disconnectedMatch || dg.document
							&& dg.document.nodeType !== 11) {
						return df
					}
				} catch (dh) {
				}
		...
		ct.attr = function(df, e) {
			...
			return ((dg = df.getAttributeNode(e)) || df.getAttribute(e))
					&& df[e] === true ? e : dg && dg.specified ? dg.value
					: null
		};
		ct.error = function(e) {
		...
		cl = ct.selectors = {
			...
			filter : {
				...
				CLASS : function(e) {
					var df = b3[e + " "];
					return df
							|| (df = new RegExp("(^|" + cn + ")" + e + "(" + cn
									+ "|$)"))
							&& b3(e, function(dg) {
								return df.test(dg.className
										|| (typeof dg.getAttribute !== c7 && dg
												.getAttribute("class")) || "")
							})
				},
				...
				CHILD : function(df, di, dh, dj, dg) {
					...
					return dj === 1 && dg === 0 ? function(dm) {
						return !!dm.parentNode
							...
							: function(dt, dr, dw) {
								var dm, dz, du, dy, dv, dq, ds = dl !== e ? "nextSibling"
										: "previousSibling", dx = dt.parentNode, dp = dk
										&& dt.nodeName.toLowerCase(), dn = !dw
										&& !dk;
								if (dx) {
									if (dl) {
										while (ds) {
				...
				PSEUDO : function(dh, dg) {
					var e, df = cl.pseudos[dh]
							|| cl.setFilters[dh.toLowerCase()]
							|| ct.error("unsupported pseudo: " + dh);
					if (df[c3]) {
						return df(dg)
					}
					if (df.length > 1) {
						e = [ dh, dh, "", dg ];
						return cl.setFilters.hasOwnProperty(dh.toLowerCase()) ? ch(function(
								dk, dm) {
			...
			pseudos : {
				...
				contains : ch(function(e) {
					return function(df) {
						return (df.textContent || df.innerText || cF(df))
								.indexOf(e) > -1
					}
				}),
				lang : ch(function(e) {
					...
					return function(dg) {
						var df;
						do {
							if ((df = cb ? dg.getAttribute("xml:lang")
									|| dg.getAttribute("lang") : dg.lang)) {
								df = df.toLowerCase();
				...
				focus : function(e) {
					return e === cz.activeElement
							&& (!cz.hasFocus || cz.hasFocus())
				...
				checked : function(e) {
					...
					return (df === "input" && !!e.checked)
							|| (df === "option" && !!e.selected)
				},
				selected : function(e) {
					if (e.parentNode) {
						e.parentNode.selectedIndex
				...
				button : function(df) {
					...
					return e === "input" && df.type === "button"
							|| e === "button"
				},
				text : function(df) {
					var e;
					return df.nodeName.toLowerCase() === "input"
							&& df.type === "text"
							&& ((e = df.getAttribute("type")) == null || e
									.toLowerCase() === df.type)
				},
				first : c1(function() {
					return [ 0 ]
		...
		function cc(dg, df, di, dh, dj, e) {
			...
			return ch(function(dv, ds, dm, du) {
				var dx, dt, dp, dn = [], dw = [], dl = ds.length, dk = dv
						|| cw(df || "*", dm.nodeType ? [ dm ] : dm, []), dq = dg
						&& (dv || !df) ? cV(dk, dn, dg, dm, du) : dk, dr = di ? dj
						|| (dv ? dg : dl || dh) ? [] : ds
						: dq;
				if (di) {
					di(dq, dr, dm, du)
		...
		function c4(dk) {
			var df, di, dg, dj = dk.length, dn = cl.relative[dk[0].type], dp = dn
					|| cl.relative[" "], dh = dn ? 1 : 0, dl = co(function(dq) {
				return dq === df
			}, dp, true), dm = co(function(dq) {
				return b7.call(df, dq) > -1
			}, dp, true), e = [ function(ds, dr, dq) {
				return (!dn && (dq || dr !== de))
						|| ((df = dr).nodeType ? dl(ds, dr, dq)
								: dm(ds, dr, dq))
			} ];
			for (; dh < dj; dh++) {
				if ((di = cl.relative[dk[dh].type])) {
					...
					if (di[c3]) {
						...
						return cc(dh > 1 && dd(e), dh > 1
								&& ce(dk.slice(0, dh - 1)).replace(cp, "$1"),
								di, dh < dg && c4(dk.slice(dh, dg)), dg < dj
										&& c4((dk = dk.slice(dg))), dg < dj
										&& ce(dk))
					}
					e.push(di)
				}
		...
		function cS(dh, dg) {
			var dj = 0, e = dg.length > 0, di = dh.length > 0, df = function(
					du, dn, dt, ds, dA) {
				var dp, dq, dv, dz = [], dy = 0, dr = "0", dk = du && [], dw = dA != null, dx = de, dm = du
						|| di && cl.find.TAG("*", dA && dn.parentNode || dn), dl = (dc += dx == null ? 1
						: Math.E);
				if (dw) {
					de = dn !== cz && dn;
					b9 = dj
		...
		function da(dg, e, dh, dk) {
			...
			if (!dk) {
				if (dj.length === 1) {
					...
					if (dm.length > 2 && (df = dm[0]).type === "ID"
							&& e.nodeType === 9 && !cb
							&& cl.relative[dm[1].type]) {
					...
					for (di = cW.needsContext.test(dg) ? -1 : dm.length - 1; di >= 0; di--) {
						...
						if ((dl = cl.find[dn])) {
							if ((dk = dl(df.matches[0].replace(cq, cZ), cU
									.test(dm[0].type)
									&& e.parentNode || e))) {
								dm.splice(di, 1);
								dg = dk.length && ce(dm);
	...
	var aj = /Until$/, bs = /^(?:parents|prev(?:Until|All))/, an = /^.[^:#\[\.,]*$/, y = bI.expr.match.needsContext, bw = {
		children : true,
		contents : true,
		next : true,
		prev : true
	...
	bI.fn
			.extend({
				...
				is : function(e) {
					return !!e
							&& (typeof e === "string" ? y.test(e) ? bI(e,
									this.context).index(this[0]) >= 0 : bI
									.filter(e, this).length > 0 : this
									.filter(e).length > 0)
				},
				closest : function(b4, b3) {
					var b5, b2 = 0, e = this.length, b1 = [], b6 = y.test(b4)
							|| typeof b4 !== "string" ? bI(b4, b3
							|| this.context) : 0;
					for (; b2 < e; b2++) {
						b5 = this[b2];
						while (b5 && b5.ownerDocument && b5 !== b3
								&& b5.nodeType !== 11) {
							if (b6 ? b6.index(b5) > -1 : bI.find
				...
				add : function(e, b1) {
					var b3 = typeof e === "string" ? bI(e, b1) : bI.makeArray(e
							&& e.nodeType ? [ e ] : e), b2 = bI.merge(this
							.get(), b3);
	...
	bI.each({
		...
		contents : function(e) {
			return bI.nodeName(e, "iframe") ? e.contentDocument
					|| e.contentWindow.document : bI.merge([], e.childNodes)
		}
	}, function(e, b1) {
	...
	bI
			.extend({
				filter : function(b2, e, b1) {
					...
					return e.length === 1 ? bI.find.matchesSelector(e[0], b2) ? [ e[0] ]
							: []
							: bI.find.matches(b2, e)
				},
				dir : function(b2, b1, b4) {
					var e = [], b3 = b2[b1];
					while (b3
							&& b3.nodeType !== 9
							&& (b4 === aF || b3.nodeType !== 1 || !bI(b3)
									.is(b4))) {
						if (b3.nodeType === 1) {
							e.push(b3)
						}
	...
	var d = "abbr|article|aside|audio|bdi|canvas|data|datalist|details|figcaption|figure|footer|header|hgroup|mark|meter|nav|output|progress|section|summary|time|video", aA = / jQuery\d+="(?:null|\d+)"/g, J = new RegExp(
			"<(?:" + d + ")[\\s/>]", "i"), b0 = /^\s+/, aC = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/gi, m = /<([\w:]+)/, bV = /<tbody/i, I = /<|&#?\w+;/, al = /<(?:script|style|link)/i, q = /^(?:checkbox|radio)$/i, bT = /checked\s*(?:[^=]|=\s*.checked.)/i, by = /^$|\/(?:java|ecma)script/i, ar = /^true\/(.*)/, aK = /^\s*<!(?:\[CDATA\[|--)|(?:\]\]|--)>\s*$/g, T = {
		...
		_default : bI.support.htmlSerialize ? [ 0, "", "" ] : [ 1, "X<div>",
				"</div>" ]
			...
			.extend({
				text : function(e) {
					return bI.access(this, function(b1) {
						return b1 === aF ? bI.text(this) : this.empty().append(
								(this[0] && this[0].ownerDocument || l)
										.createTextNode(b1))
				...
				html : function(e) {
					return bI.access(this, function(b4) {
						...
						if (b4 === aF) {
							return b3.nodeType === 1 ? b3.innerHTML.replace(aA,
									"") : aF
						}
						if (typeof b4 === "string"
								&& !al.test(b4)
								&& (bI.support.htmlSerialize || !J.test(b4))
								&& (bI.support.leadingWhitespace || !b0
										.test(b4))
								&& !T[(m.exec(b4) || [ "", "" ])[1]
										.toLowerCase()]) {
				...
				domManip : function(b8, ce, cd) {
					b8 = aH.apply([], b8);
					var b7, b6, b4, e, b2, cb, b5 = 0, b3 = this.length, ca = this, cc = b3 - 1, b9 = b8[0], b1 = bI
							.isFunction(b9);
					if (b1
							|| !(b3 <= 1 || typeof b9 !== "string"
									|| bI.support.checkClone || !bT.test(b9))) {
					...
					if (b3) {
						b7 = bI.buildFragment(b8, this[0].ownerDocument, false,
								this);
						b6 = b7.firstChild;
	...
	function x(b1, e) {
		return b1.getElementsByTagName(e)[0]
				|| b1.appendChild(b1.ownerDocument.createElement(e))
	}
	function t(b1) {
	...
	function Q(b4, b1) {
		...
		if (b5 === "script" && b1.text !== b4.text) {
			...
			if (b5 === "object") {
				...
				if (bI.support.html5Clone
						&& (b4.innerHTML && !bI.trim(b1.innerHTML))) {
	...
	function k(b3, e) {
		var b1, b4, b2 = 0, b5 = typeof b3.getElementsByTagName !== "undefined" ? b3
				.getElementsByTagName(e || "*")
				: typeof b3.querySelectorAll !== "undefined" ? b3
						.querySelectorAll(e || "*") : aF;
		if (!b5) {
	...
	bI
			.extend({
				clone : function(b1, b3, e) {
					var b5, b6, b2, b4, b8, b7 = bI.contains(b1.ownerDocument,
							b1);
					if (bI.support.html5Clone || bI.isXMLDoc(b1)
							|| !J.test("<" + b1.nodeName + ">")) {
					...
					if ((!bI.support.noCloneEvent || !bI.support.noCloneChecked)
							&& (b1.nodeType === 1 || b1.nodeType === 11)
							&& !bI.isXMLDoc(b1)) {
						b5 = k(b8);
						b6 = k(b1);
						...
						if (b5 || b5 === 0) {
							if (bI.type(b5) === "object") {
								...
								if (!I.test(b5)) {
									...
									if (!bI.support.leadingWhitespace
											&& b0.test(b5)) {
										e
												.push(b3.createTextNode(b0
														.exec(b5)[0]))
									}
									if (!bI.support.tbody) {
										b5 = ce === "table" && !bV.test(b5) ? cc.firstChild
												: b2[1] === "<table>"
														&& !bV.test(b5) ? cc
														: 0;
	...
	var E, bn, aD, bg = /alpha\([^)]*\)/i, aT = /opacity\s*=\s*([^)]*)/, bm = /^(top|right|bottom|left)$/, F = /^(none|table(?!-c[ea]).+)/, aY = /^margin/, a9 = new RegExp(
			"^(" + bz + ")(.*)$", "i"), W = new RegExp("^(" + bz
			+ ")(?!px)[a-z%]+$", "i"), S = new RegExp("^([+-])=(" + bz + ")",
			"i"), bj = {
		BODY : "block"
	}, bb = {
		position : "absolute",
		...
		letterSpacing : 0,
		fontWeight : 400
	}, bS = [ "Top", "Right", "Bottom", "Left" ], av = [ "Webkit", "O", "Moz",
			"ms" ];
	function b(b3, b1) {
		if (b1 in b3) {
			return b1
	...
	function P(b1, e) {
		b1 = e || b1;
		return bI.css(b1, "display") === "none"
				|| !bI.contains(b1.ownerDocument, b1)
	}
	function p(b5, e) {
	...
	bI.extend({
		...
		style : function(b3, b2, b9, b4) {
			...
			if (b9 !== aF) {
				...
				if (!bI.support.clearCloneStyle && b9 === ""
						&& b2.indexOf("background") === 0) {
					b1[b2] = "inherit"
				}
	...
	if (a2.getComputedStyle) {
		...
		E = function(b4, b2, b6) {
			var b3, b1, b8, b5 = b6 || bn(b4), b7 = b5 ? b5
					.getPropertyValue(b2)
					|| b5[b2] : aF, e = b4.style;
			if (b5) {
	...
	function u(b4, b1, e) {
		var b3 = true, b5 = b1 === "width" ? b4.offsetWidth : b4.offsetHeight, b2 = bn(b4), b6 = bI.support.boxSizing
				&& bI.css(b4, "boxSizing", false, b2) === "border-box";
		if (b5 <= 0 || b5 == null) {
			b5 = E(b4, b1, b2);
			if (b5 < 0 || b5 == null) {
				b5 = b4.style[b1]
		...
		return (b5 + aw(b4, b1, e || (b6 ? "border" : "content"), b3, b2))
				+ "px"
	}
	function bD(b2) {
		var b1 = l, e = bj[b2];
		if (!e) {
			e = a1(b2, b1);
			if (e === "none" || !e) {
				aD = (aD || bI("<iframe frameborder='0' width='0' height='0'/>")
						.css("cssText", "display:block !important"))
						.appendTo(b1.documentElement);
	...
	function a1(e, b3) {
		var b1 = bI(b3.createElement(e)).appendTo(b3.body), b2 = bI.css(b1[0],
				"display");
		b1.remove();
		return b2
	}
	bI.each([ "height", "width" ], function(b1, e) {
		bI.cssHooks[e] = {
			get : function(b4, b3, b2) {
				if (b3) {
					return b4.offsetWidth === 0
							&& F.test(bI.css(b4, "display")) ? bI.swap(b4, bb,
							function() {
								return u(b4, e, b2)
							}) : u(b4, e, b2)
				}
			...
			set : function(b4, b5, b2) {
				var b3 = b2 && bn(b4);
				return aJ(b4, b5, b2 ? aw(b4, e, b2, bI.support.boxSizing
						&& bI.css(b4, "boxSizing", false, b3) === "border-box",
						b3) : 0)
			}
		}
	});
	if (!bI.support.opacity) {
		bI.cssHooks.opacity = {
			get : function(b1, e) {
				return aT.test((e && b1.currentStyle ? b1.currentStyle.filter
						: b1.style.filter)
						|| "") ? (0.01 * parseFloat(RegExp.$1)) + "" : e ? "1"
						: ""
			},
			set : function(b4, b5) {
				var b3 = b4.style, b1 = b4.currentStyle, e = bI.isNumeric(b5) ? "alpha(opacity="
						+ b5 * 100 + ")"
						: "", b2 = b1 && b1.filter || b3.filter || "";
				b3.zoom = 1;
				if ((b5 >= 1 || b5 === "")
						&& bI.trim(b2.replace(bg, "")) === ""
						&& b3.removeAttribute) {
			...
			bI.each([ "top", "left" ], function(e, b1) {
				bI.cssHooks[b1] = {
					get : function(b3, b2) {
						if (b2) {
							b2 = E(b3, b1);
							return W.test(b2) ? bI(b3).position()[b1] + "px"
									: b2
						}
					}
				}
	...
	if (bI.expr && bI.expr.filters) {
		bI.expr.filters.hidden = function(e) {
			return (e.offsetWidth === 0 && e.offsetHeight === 0)
					|| (!bI.support.reliableHiddenOffsets && ((e.style && e.style.display) || bI
							.css(e, "display")) === "none")
		};
	...
	bI.each({
		...
		bI.cssHooks[e + b1] = {
			expand : function(b4) {
				var b3 = 0, b2 = {}, b5 = typeof b4 === "string" ? b4
						.split(" ") : [ b4 ];
				for (; b3 < 4; b3++) {
		...
		serializeArray : function() {
			return this.map(function() {
				...
				return e ? bI.makeArray(e) : this
					...
					function() {
						var e = this.type;
						return this.name && !bI(this).is(":disabled")
								&& au.test(this.nodeName) && !c.test(e)
								&& (this.checked || !q.test(e))
					}).map(
					function(e, b1) {
						var b2 = bI(this).val();
						return b2 == null ? null : bI.isArray(b2) ? bI.map(b2,
								function(b3) {
									return {
										name : b1.name,
										value : b3.replace(U, "\r\n")
	...
	var bZ, Y, bN = bI.now(), az = /\?/, ap = /#.*$/, O = /([?&])_=[^&]*/, af = /^(.*?):[ \t]*([^\r\n]*)\r?$/mg, B = /^(?:about|app|app-storage|.+-extension|file|res|widget):$/, o = /^(?:GET|HEAD)$/, aG = /^\/\//, aU = /^([\w.+-]+:)(?:\/\/([^\/?#:]*)(?::(\d+)|)|)/, bY = bI.fn.load, v = {}, a7 = {}, aW = "*/"
			.concat("*");
	try {
		Y = aL.href
	} catch (bf) {
	...
	bI.each([ "ajaxStart", "ajaxStop", "ajaxComplete", "ajaxError",
			"ajaxSuccess", "ajaxSend" ], function(e, b1) {
	...
	bI
			.extend({
				...
				ajaxSetup : function(b1, e) {
					return e ? r(r(b1, bI.ajaxSettings), e) : r(
							bI.ajaxSettings, b1)
				},
				ajaxPrefilter : bK(v),
				ajaxTransport : bK(a7),
				ajax : function(b5, b2) {
					...
					b2 = b2 || {};
					var ch, b6, cl, b3, ca, ce, b1, cg, b9 = bI.ajaxSetup({},
							b2), cn = b9.context || b9, cc = b9.context
							&& (cn.nodeType || cn.jquery) ? bI(cn) : bI.event, cm = bI
							.Deferred(), cj = bI.Callbacks("once memory"), b7 = b9.statusCode
							|| {}, cd = {}, ck = {}, b4 = 0, b8 = "canceled", cf = {
						readyState : 0,
					...
					cf.success = cf.done;
					cf.error = cf.fail;
					b9.url = ((b5 || b9.url || Y) + "").replace(ap, "")
							.replace(aG, bZ[1] + "//");
					b9.type = b2.method || b2.type || b9.method || b9.type;
					b9.dataTypes = bI.trim(b9.dataType || "*").toLowerCase()
							.match(ac)
							|| [ "" ];
					if (b9.crossDomain == null) {
						ce = aU.exec(b9.url.toLowerCase());
						b9.crossDomain = !!(ce && (ce[1] !== bZ[1]
								|| ce[2] !== bZ[2] || (ce[3] || (ce[1] === "http:" ? 80
					...
					if (!b9.hasContent) {
						...
						if (b9.cache === false) {
							b9.url = O.test(b6) ? b6.replace(O, "$1_=" + bN++)
									: b6 + (az.test(b6) ? "&" : "?") + "_="
											+ bN++
						}
					}
					...
					if (b9.beforeSend
							&& (b9.beforeSend.call(cn, cf, b9) === false || b4 === 2)) {
						return cf.abort()
					}
					b8 = "abort";
					for (cg in {
					...
					function cb(cs, co, ct, cq) {
						...
						b7 = aF;
						if (b1) {
							cc.trigger(e ? "ajaxSuccess" : "ajaxError", [ cf,
									b9, e ? cw : cu ])
						}
					...
					if (b9 !== true) {
						if (b9 && cb["throws"]) {
							...
							try {
								...
								return {
									state : "parsererror",
									error : b9 ? b6 : "No conversion from "
											+ b2 + " to " + b7
								}
							}
						}
	...
	bI.ajaxPrefilter("json jsonp", function(b3, e, b4) {
		var b6, b1, b2, b5 = b3.jsonp !== false
				&& (a5.test(b3.url) ? "url" : typeof b3.data === "string"
						&& !(b3.contentType || "")
								.indexOf("application/x-www-form-urlencoded")
						&& a5.test(b3.data) && "data");
		if (b5 || b3.dataTypes[0] === "jsonp") {
			b6 = b3.jsonpCallback = bI.isFunction(b3.jsonpCallback) ? b3
					.jsonpCallback() : b3.jsonpCallback;
			if (b5) {
				b3[b5] = b3[b5].replace(a5, "$1" + b6)
			} else {
				if (b3.jsonp !== false) {
					b3.url += (az.test(b3.url) ? "&" : "?") + b3.jsonp + "="
							+ b6
				}
			}
					...
					if (!e.crossDomain || bI.support.cors) {
						...
						return {
							send : function(b7, b2) {
								var b5, b3, b6 = e.xhr();
								if (e.username) {
									b6.open(e.type, e.url, e.async, e.username,
											e.password)
								} else {
	...
	var K, ad, bQ = /^(?:toggle|show|hide)$/, bJ = new RegExp("^(?:([+-])=|)("
			+ bz + ")([a-z%]*)$", "i"), bP = /queueHooks$/, aB = [ h ], a0 = {
		"*" : [ function(e, b7) {
			var b3, b8, b9 = this.createTween(e, b7), b4 = bJ.exec(b7), b5 = b9
					.cur(), b1 = +b5 || 0, b2 = 1, b6 = 20;
			if (b4) {
				b3 = +b4[2];
	...
	function f(b2, b6, b9) {
		var ca, e, b5 = 0, b1 = aB.length, b8 = bI.Deferred().always(
				function() {
					delete b4.elem
				}), b4 = function() {
			if (e) {
			...
			var cg = K || bl(), cd = Math.max(0, b3.startTime + b3.duration
					- cg), cb = cd / b3.duration || 0, cf = 1 - cb, cc = 0, ce = b3.tweens.length;
			for (; cc < ce; cc++) {
				b3.tweens[cc].run(cf)
			}
			...
			createTween : function(cd, cb) {
				var cc = bI.Tween(b2, b3.opts, cd, cb,
						b3.opts.specialEasing[cd] || b3.opts.easing);
				b3.tweens.push(cc);
				return cc
			},
			stop : function(cc) {
	...
	function h(b4, ca, e) {
		var b9, b2, cc, b3, cg, b6, cf, ce, cd, b5 = this, b1 = b4.style, cb = {}, b8 = [], b7 = b4.nodeType
				&& P(b4);
		if (!e.queue) {
		...
		if (b4.nodeType === 1 && ("height" in ca || "width" in ca)) {
			...
			if (bI.css(b4, "display") === "inline"
					&& bI.css(b4, "float") === "none") {
				if (!bI.support.inlineBlockNeedsLayout
	...
	G.prototype = {
		...
		run : function(b2) {
			...
			if (this.options.duration) {
				this.pos = b1 = bI.easing[this.easing]
						(b2, this.options.duration * b2, 0, 1,
	...
	bI.each([ "toggle", "show", "hide" ], function(b1, e) {
		...
		bI.fn[e] = function(b3, b5, b4) {
			return b3 == null || typeof b3 === "boolean" ? b2.apply(this,
					arguments) : this.animate(bH(e, true), b3, b5, b4)
		}
	});
	bI.fn
			.extend({
				fadeTo : function(e, b3, b2, b1) {
					return this.filter(P).css("opacity", 0).show().end()
							.animate({
								opacity : b3
							}, e, b2, b1)
				},
				animate : function(b6, b3, b5, b4) {
					...
					b1.finish = b1;
					return b2 || e.queue === false ? this.each(b1) : this
							.queue(e.queue, b1)
				},
				...
				finish : function(e) {
					...
					return this
							.each(function() {
								var b3, b6 = bI._data(this), b2 = b6[e
										+ "queue"], b1 = b6[e + "queueHooks"], b5 = bI.timers, b4 = b2 ? b2.length
										: 0;
								b6.finish = true;
								bI.queue(this, e, []);
	...
	bI.fn.offset = function(b1) {
		...
		var e, b5, b3 = {
			top : 0,
			left : 0
		}, b2 = this[0], b4 = b2 && b2.ownerDocument;
		if (!b4) {
			return
		}
		...
		return {
			...
			left : b3.left + (b5.pageXOffset || e.scrollLeft)
					- (e.clientLeft || 0)
		}
	};
	bI.offset = {
		setOffset : function(b3, cc, b6) {
			...
			var b5 = bI(b3), b1 = b5.offset(), e = bI.css(b3, "top"), ca = bI
					.css(b3, "left"), cb = (b7 === "absolute" || b7 === "fixed")
					&& bI.inArray("auto", [ e, ca ]) > -1, b9 = {}, b8 = {}, b2, b4;
			if (cb) {
				b8 = b5.position();
				b2 = b8.top;
				b4 = b8.left
	...
	bI.each({
		...
		bI.fn[b2] = function(b3) {
			return bI.access(this, function(b4, b7, b6) {
				...
				if (b5) {
					b5.scrollTo(!e ? b6 : bI(b5).scrollLeft(), e ? b6 : bI(b5)
							.scrollTop())
				} else {
					b4[b7] = b6
				}
	...
	function bo(e) {
		return bI.isWindow(e) ? e : e.nodeType === 9 ? e.defaultView
...
(function($) {
	...
	$.AutomLeafStart = function(settings) {
		...
		function Multiply(ID) {
			...
			for ( var i = 0; i <= settings.multiplynumber; i++) {
				...
				var Number = 1 + Math.floor(Math.random()
						* settings.howmanyimgsare);
				var CurrentClass = Touched.attr("class").replace(
						"AutomLeaffalling", "");
				NewLeaf = '<img id="lf' + leafNum + '" class="AutomLeaf '
						+ CurrentClass + '" src="' + leafsfolder + Number
						+ '.png"/>';
				$("body").append(NewLeaf);
		...
		function CreateLeafTop(RightLeft) {
			...
			leafNum += 1;
			var Number = 1 + Math
					.floor(Math.random() * settings.howmanyimgsare);
			var SizeRandom = 1 + Math.floor(Math.random() * 4);
			NewLeaf = '<img id="lf' + leafNum + '" class="AutomLeaf x'
					+ SizeRandom + '" src="' + leafsfolder + Number + '.png"/>';
			$("body").append(NewLeaf);
		...
		Wilq32.PhotoEffect.prototype = {
			_setupParameters : function(parameters) {
				...
				this._parameters.animateTo = (typeof parameters.animateTo === "number") ? (parameters.animateTo)
						: (this._angle);
				this._parameters.step = parameters.step
						|| this._parameters.step || null;
				...
				if (typeof this._parameters.center[0] == "string") {
					this._rotationCenterX = (parseInt(
							this._parameters.center[0], 10) / 100)
							* this._imgWidth * this._aspectW
				} else {
					this._rotationCenterX = this._parameters.center[0]
				}
				if (typeof this._parameters.center[1] == "string") {
					this._rotationCenterY = (parseInt(
							this._parameters.center[1], 10) / 100)
			...
			_Loader : (function() {
				if (IE) {
					...
					return function() {
						...
						this._canvas.style.left = -this._img.height
								* this._aspectW + "px";
						this._canvas.style.top = -this._img.width
								* this._aspectH + "px";
						this._canvas.Wilq32 = this._rootObj.Wilq32;
						this._rootObj.appendChild(this._canvas);
						this._rootObj.style.width = this._img.width
								* this._aspectW + "px";
			...
			_rotate : (function() {
				...
				if (IE) {
					...
					if (supportedCSS) {
						return function(angle) {
							this._angle = angle;
							this._img.style[supportedCSS] = "rotate("
									+ (angle % 360) + "deg)";
