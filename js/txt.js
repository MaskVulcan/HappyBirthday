...
var TEXT;
num = 0;
TEXTArray = ["^_^","亲","爱","的", "傻", "瓜", "你", "要", "快","乐","^_^"];
...
//			var _card =
			document.getElementById("_card").innerHTML="这儿还有张贺卡        ";
//			document.getElementById("div").setAttribute("background-color", "pink");
			document.getElementById("div").style.background ="pink";
			num = 0;
		}
		//alert(TEXT);
